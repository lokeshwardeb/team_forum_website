                    ...
                    <div class="container">
                        <div class="content-section">
                            <div class="add_blog_section  ">
                                ...
                                <div class="warning_section text-danger fs-2 text-center m-4 p-4">
                                    Are your want to delete the blog post? Are you sure?
                                </div>

                                <div class="alert_section">
                                    <?php

                                    $blog_id = $controllers->pure_data($_GET['del_blog_sl_no']);

                                    if (!isset($_GET['del_blog_sl_no'])) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" disabled name="title" id="title" class="form-control" placeholder="Enter Title" value="<?php echo $show_title ?>">


                                                    <input type="text" name="blog_id" id="title" class="form-control" placeholder="Enter Title" value="<?php echo $blog_id ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <label for="catagory" class="fw-bold m-2">Catagory</label>
                                                    <select name="catagory" disabled class="form-control" id="">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" disabled name="sub_title" id="sub_title" class="form-control" placeholder="Enter Title" value="<?php echo $show_sub_title ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-sm-12">
                                                <div class="mb-3">
                                                    <label for="sub_title" class="fw-bold m-2">Article</label>
                                                    <textarea name="article" disabled id="article" class="form-control" placeholder="Write your article" cols="30" rows="10"><?php echo $controllers->pure_data($show_article);   ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="mb-3 ">
                                                    <button type="submit" class="btn btn-outline-danger mt-4 mb-4" name="delete_blog_btn">Yes, I confirm delete the blog</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
