...
$Routes = [
    ...
    '/mail' => __DIR__ . '/views/pages/views.mail.php',
    '/email_verify' => __DIR__ . '/views/pages/views.email_verify.php',
    '/email_verify_otp_confirm' => __DIR__ . '/views/pages/views.email_verify_otp_confirm.php',
    '/recover_pass' => __DIR__ . '/views/pages/views.recover_pass_send_otp.php',
    '/recover_change_pass' => __DIR__ . '/views/pages/views.recover_change_pass.php',
    // '/test_mail' => __DIR__ . '/views/pages/views.test_mail.php',
    ...
    '/manage_users' => __DIR__ . '/views/pages/dashboard/views.manage_users.php',
    '/team_workspaces' => __DIR__ . '/views/pages/views.login_workspaces.php',
    '/workspaces_dashboard' => __DIR__ . '/views/pages/workspaces/views.workspaces_dashboard.php',
    '/create_new_project' => __DIR__ . '/views/pages/workspaces/views.workspaces_create_new_project.php',
    '/workspaces_all_projects' => __DIR__ . '/views/pages/workspaces/views.workspaces_all_projects.php',
